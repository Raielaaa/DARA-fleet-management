...
class ViewInquiriesOutsource extends StatefulWidget {
  const ViewInquiriesOutsource({super.key});

  @override
  State<ViewInquiriesOutsource> createState() => _ViewInquiriesOutsourceState();
}

class _ViewInquiriesOutsourceState extends State<ViewInquiriesOutsource> {
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ViewInquiryOutsource(rentInfo: completeRentInfo))
                      );
                    },
                    child: Container(
                      decoration: BoxDecoration(
