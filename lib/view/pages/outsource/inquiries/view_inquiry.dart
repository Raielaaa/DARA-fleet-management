...
class ViewInquiryOutsource extends StatefulWidget {
  final RentInformation rentInfo;
  const ViewInquiryOutsource({
    Key? key,
    required this.rentInfo
  }) : super(key: key);

  @override
  State<ViewInquiryOutsource> createState() => _ViewInquiryOutsourceState();
}

class _ViewInquiryOutsourceState extends State<ViewInquiryOutsource> {
