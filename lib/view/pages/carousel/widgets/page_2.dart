        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Image.asset(
                "lib/assets/pictures/carousel_image_2.png",
            ...
            DefaultTextStyle(
              ...
              child: Text(ProjectStrings.carousel_2_header, style: const TextStyle(color: Color.fromARGB(210, 0, 0, 0))),
            ),
            const SizedBox(height: 20),
            DefaultTextStyle(
              ...
              child: Padding(
                ...
                child: Text(ProjectStrings.carousel_2_body, style: const TextStyle(color: Color.fromARGB(200, 0, 0, 0))),
              ),
            ),
